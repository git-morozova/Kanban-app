...
export const disabledActivator = function () {
  ...
  storageData.some((e) => e.step === "backlog")
    ? (ready.disabled = false)
    : false;
  storageData.some((e) => e.step === "ready")
    ? (inprogress.disabled = false)
    : false;
  storageData.some((e) => e.step === "inprogress")
...
export const changeMenuItems = function () {
  document
    .querySelector("#app-profile-btn")
    .classList.replace("hidden", "visible");
  document
    .querySelector("#app-users-btn")
    .classList.replace("hidden", "visible");
